...
export default function Home() {
  ...
  const [aba, setAba] = useState("Visão geral"),
    ...
    [produtosGestao, setProdutosGestao] = useState(
      catalogo.map((p, i) => ({
        ...
        id: i + 1,
        ativo: true,
        imagem: imagemProduto(p),
        descricao: descricaoProduto(p),
        fonte: fonteProduto(p),
      })),
    ),
    [gestaoProdutos, setGestaoProdutos] = useState(true),
    [produtoApresentacao, setProdutoApresentacao] = useState(null),
    [buscaGestaoProduto, setBuscaGestaoProduto] = useState(""),
    [novoProduto, setNovoProduto] = useState(null),
  ...
  const abrirProduto = (prod) => {
    ...
    setProdutoApresentacao({
      ...info,
      ...prod,
      imagem: info.imagem || prod.imagem || "",
    });
  };
                      ...
                      <div className="numbers">
                        <div>
                          ...
                          <input
                            ...
                            onInput={(e) => {
                              contagem[p.nome] = e.currentTarget.value;
                            }}
                          />
                        </div>
                        <div>
        ...
        <div className="panel productManager">
          <div className="title">
            <div>
              ...
              <p>
                Cadastre, edite, ative ou desative os produtos disponíveis para
                a equipe comercial.
              </p>
            </div>
            <button
              className="primary"
              onClick={() => setGestaoProdutos(!gestaoProdutos)}
            >
              {gestaoProdutos ? "Fechar produtos" : "Gerenciar produtos"}
            </button>
          </div>
          {gestaoProdutos && (
            <>
              <div className="productManagerTools">
                <input
                  placeholder="Buscar produto, linha ou marca..."
                  value={buscaGestaoProduto}
                  onChange={(e) => setBuscaGestaoProduto(e.target.value)}
                />
                <button
                  onClick={() =>
                    setNovoProduto({
              ...
              <div className="productAdminList">
                {produtosGestao
                  .filter((p) =>
                    (p.nome + " " + (p.marca || "") + " " + (p.familia || ""))
                      .toLowerCase()
                      .includes(buscaGestaoProduto.toLowerCase()),
                  )
                  .map((p) => (
                    <article
                      key={p.id}
                      className={!p.ativo ? "productOff" : ""}
                    >
                      <input
                        type="checkbox"
                        checked={p.ativo}
                      ...
                      {p.imagem ? (
                        ...
                        <div className="adminProductNoImg">—</div>
                      )}
                      <div>
                        <strong>{p.nome}</strong>
                        <small>
                      ...
                      <span
                        className={
                          p.ativo ? "activeProduct" : "inactiveProduct"
                        }
                      >
                        {p.ativo ? "ATIVO" : "INATIVO"}
                      </span>
                      <button onClick={() => setNovoProduto({ ...p })}>
                        Editar
                      </button>
                    </article>
                  ))}
  ...
  return (
    <main>
      {produtoApresentacao && (
        <div className="modalBack productPresentationBack">
          <div className="productPresentation">
            <button
              className="presentationClose"
              type="button"
              onClick={() => setProdutoApresentacao(null)}
            >
              ×
            </button>
            <div className="presentationVisual">
              {produtoApresentacao.imagem ? (
                <img
                  src={produtoApresentacao.imagem}
                  alt={produtoApresentacao.nome}
                />
              ) : (
                <div className="presentationPlaceholder">
                  <span>IMG</span>
            ...
            <div className="presentationInfo">
              <small>{produtoApresentacao.marca || "Austen"}</small>
              <h2>{produtoApresentacao.nome}</h2>
              <p className="presentationFamily">
                {produtoApresentacao.familia || produtoApresentacao.linha || ""}
              </p>
              <div className="presentationSpecs">
                {produtoApresentacao.tamanho && (
                  <div>
                    <span>Tamanho</span>
                    <b>{produtoApresentacao.tamanho}</b>
                  </div>
                )}
                {produtoApresentacao.unidades && (
                  <div>
                    <span>Apresentação</span>
                    <b>{produtoApresentacao.unidades} un.</b>
                  </div>
                )}
                <div>
                  <span>Linha</span>
                  <b>{produtoApresentacao.linha || "—"}</b>
                </div>
              </div>
              <div className="presentationBenefits">
                <h3>Informações do produto</h3>
                <p>
                  {produtoApresentacao.descricao ||
                    "Informações comerciais do produto."}
                </p>
                {produtoApresentacao.fonte && (
                  <a
                    className="officialSource"
                    href={produtoApresentacao.fonte}
                    target="_blank"
                    rel="noreferrer"
                  >
                    Ver ficha oficial
        ...
        <div className="modalBack">
          ...
          >
            <div className="modalTitle">
              <div>
                <small>GESTÃO DE PRODUTOS</small>
                <h2>{novoProduto.id ? "Editar produto" : "Novo produto"}</h2>
              </div>
              <button
                type="button"
                className="close"
            ...
            <div className="formGrid">
              ...
              <label>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNovoProduto({ ...novoProduto, familia: e.target.value })
                  }
                />
              </label>
              <label>
              ...
              <label className="fullField">
                ...
                <input
                  ...
                  placeholder="Informações para apresentar ao comprador"
                />
              </label>
              <label>
                Status
            ...
            <div className="modalActions">
              {novoProduto.id && (
                <button
                  ...
                  onClick={() => {
                    setProdutosGestao(
                      produtosGestao.filter((p) => p.id !== novoProduto.id),
                    );
                    setNovoProduto(null);
                  }}
                >
